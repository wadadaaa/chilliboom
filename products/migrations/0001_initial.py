...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'products_catalog', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=80)),
            ('slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=50)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='children', null=True, to=orm['products.Catalog'])),
        ))
        db.send_create_signal(u'products', ['Catalog'])
        ...
        db.create_table(u'products_product', (
            ...
            ('catalog', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['products.Catalog'])),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('submitter', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ...
        db.create_table(u'products_profile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('bio', self.gf('django.db.models.fields.TextField')(null=True)),
        ))
        db.send_create_signal(u'products', ['Profile'])


    def backwards(self, orm):
        # Deleting model 'Catalog'
        db.delete_table(u'products_catalog')
        ...
        db.delete_table(u'products_profile')
    ...
    models = {
        ...
        u'products.catalog': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'children'", 'null': 'True', 'to': u"orm['products.Catalog']"}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '50'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '80'})
        },
        u'products.product': {
            'Meta': {'object_name': 'Product'},
            'catalog': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['products.Catalog']"}),
